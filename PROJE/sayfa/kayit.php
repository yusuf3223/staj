              ...
              <?php 
			   ...
			   <form method="post">
			       <div class="form-group">
					   ...
					   <input type="name" name="adi" class="form-control">
				   </div>
                   <div class="form-group">
				       <label for="soadi">Soyadı</label>
					   <input type="surname" name="soyadi" class="form-control">
				   </div> 
                   <div class="form-group">
				   ...
				   <div class="form-group">
				       <label for="Sifree">Şifre Tekrarı</label>
					   <input type="password" name="sifree" class="form-control">
				   </div> 
