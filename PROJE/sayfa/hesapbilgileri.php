 ...
 <div class="container mt-5">
   <div class="row">
       <div class="col-6 mx-auto">
	     <div class="card">
	       <div class="card-header bg-bremary " style="text-align:center">
		     <h4>Hesap Bilgileri</h4>
		   </div>
		   <?php
		   include '../php/hesapbilgisicek.php' ;
		   ?>
		   <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="col-sm-10"> 
                                    ...
                                    <input type="password" class="form-control" id="sifre" placeholder="Şifre" name="sifre" value="<?php echo $sifre;?>" READONLY>
                                </div>
                            </div>
							<div class="form-group">
                                <div class="col-sm-10"> 
                                    <label for="adi">Kayıt Tarihi</label>								
                                    <input type="text" class="form-control" id="tarih" placeholder="Şifre" name="tarih" value="<?php echo $tarih;?>" READONLY>
                                </div>
                            </div>
             </div> 
