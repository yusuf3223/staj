        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty146/product/media/images/20210715/14/110869462/149963396/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty145/product/media/images/20210715/14/110869462/149963396/5/5_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty146/product/media/images/20210715/14/110869462/149963396/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Geniş Paça Pantolon" readonly></h1>
                    
                    <hr>

                    <h6>ModaRoll Kadın Mavi Kar Yıkamalı Salaş Likralı Süper Yüksek Bel Geniş Paça Jean (SÜPER YÜKSEK) MEİSSA0233 </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            Extra Yüksek Bel Geniş Paça Jean
                        </li>
                        <li class="text-muted">
                           Kumaş Cinsi 1 : %97 PAMUK % 3 ELASTAN
                        </li>
                        <li class="text-muted">
                            Sezon : FW
                        </li>
						<li class="text-muted">
                           Modelin Ölçüleri : 1.75 cm / 36 Beden
                        </li>
						<li class="text-muted">
                            Modelin Üstündeki Beden : T-36
                        </li>
						<li class="text-muted">
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="80" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>249TL</del></span></small></h2>
