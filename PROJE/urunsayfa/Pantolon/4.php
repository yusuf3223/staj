        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty110/product/media/images/20210503/11/84993621/169962126/0/0_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty109/product/media/images/20210503/11/84993621/169962126/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty108/product/media/images/20210503/11/84993621/169962126/3/3_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Lastikli Kordonlu Pantolon" readonly></h1>
                    
                    <hr>

                    <h6>Avva Erkek Açık Gri Yandan Cepli Beli Lastikli Kordonlu Düz Relaxed Fit Pantolon E003000 </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            Yandan Cepli Beli Lastikli Kordonlu Düz Relaxed Fit Pantolon İlkbahar/Yaz Sezonu Ürünüdür.
                        </li>
                        <li class="text-muted">
                           Model Boy: 188 cm Göğüs: 98 cm Bel: 82 cm Basen: 96 cm
                        </li>
                        <li class="text-muted">
                            Numune Beden: 31
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="97" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>349TL</del></span></small></h2>
