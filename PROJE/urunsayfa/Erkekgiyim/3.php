        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty132/product/media/images/20210618/11/102087136/190325406/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty132/product/media/images/20210618/11/102087136/190325406/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty132/product/media/images/20210618/11/102087136/190325406/3/3_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="3lü Boxer Paketi" readonly></h1>
                    
                    <hr>

                    <h6>Altınyıldız Classics Erkek Gri-lacivert-siyah 3lü Boxer Paketi </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                         %95 Pamuk, %5 Elastan, Düz Gri-Lacivert, Standart Fit, Casual Model, AC&Co / ALTINYILDIZ Classics 3'lü Boxer Paketi, Ürün Bedeni: L, Manken Ölçüleri: Boy: 1.89cm, Kilo: 80kg, Ürün Kodu: 4A03212P3007GLC.
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="59" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>99TL</del></span></small></h2>
