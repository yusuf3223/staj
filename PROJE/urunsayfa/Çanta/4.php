        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty41/product/media/images/20201230/10/43498580/120887398/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty42/product/media/images/20201230/10/43498580/120887398/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty107/product/media/images/20210421/16/81920364/157586213/4/4_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="cuzdan kombini ve Çanta" readonly></h1>
                    
                    <hr>

                    <h6>Just Polo Kadın Kahverengi El Omuz Çantası Ve Cüzdan Kombini </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                           Kombin olarak satılmaktadır Çantamıza ait ölçüler en 30 boy 21 derinlik 13 cm. Cüzdanımıza it ölçüler yükseklik 15 cm, en 9 cm derinlik 9 cm'dir. 10 adet kartlık gözü,1 fermuarlı bölme bulunmaktadır. Yeni sezon monogram baskılı kaliteli astar ve fermuar kullanılmıştır.
                        </li>
                    
                        <li class="text-muted">
                           Zincirli Elde Tutulabilir
                        </li>
						<li class="text-muted">
                           Uzun Omuz Askılı
                        </li>
						...
						<li class="text-muted">
                            Metal Klips Kapamalı
                        </li>
						<li class="text-muted">
                            İki Bölmeli ve Ön Gözü Bulunmaktadır
                        </li>
						<li class="text-muted">
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="258" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>271TL</del></span></small></h2>
