        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty151/product/media/images/20210730/20/114190959/215668916/0/0_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty150/product/media/images/20210730/20/114190959/215668916/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty150/product/media/images/20210730/20/114190959/215668916/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Yesil Omuz Çanta" readonly></h1>
                    
                    <hr>

                    <h6>Madamra Yeşil Kadın Kapitone Zincirli El Ve Omuz Çantası </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                          Ebatlar: En:19 Cm, Boy:16 Cm, Genişlik:7 Cm Kapitone El Ve Omuz Çantası suni deri ve soft malzemeden üretilmiştir. İçerisinde astarı bulunan ürünümüz zincir askı detayı ile süslenmiştir.
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="74" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>115TL</del></span></small></h2>
