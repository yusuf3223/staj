        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty106/product/media/images/20210421/16/81920364/157586213/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty105/product/media/images/20210421/16/81920364/157586213/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Timsah Desenli Çanta" readonly></h1>
                    
                    <hr>

                    <h6>Ludo Vico Kadın Siyah Timsah Desenli Omuz Çantası </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                           Ölçüleri Yükseklik 14cm Uzunluk 20cm En 7cm
                        </li>
                        <li class="text-muted">
                           Timsah Desenli Çanta
                        </li>
                        <li class="text-muted">
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="73" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>120TL</del></span></small></h2>
