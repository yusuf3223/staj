        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty145/product/media/images/20210712/14/109756928/64037433/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty144/product/media/images/20210712/14/109756928/64037433/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty146/product/media/images/20210712/14/109756928/64037433/3/3_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Kadın Pudra Sneaker" readonly></h1>
                    
                    <hr>

                    <h6>Dark Seer Kadın Pudra Sneaker </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                           1.KALİTE TRİKO MALZEMEDEN ÜRETİLMİŞTİR.
                        </li>
                        <li class="text-muted">
                           Kadın Manken Ayakkabı Ölçüsü:38 Numara
                        </li>
                        <li class="text-muted">
                           Poliüretan, Kaymaz, Yumuşak ve Ortopedik Taban
                        </li>
						<li class="text-muted">
                           1.Sınıf Hava Kanallı Malzeme
                        </li>
						<li class="text-muted">
                          Koku ve Terleme Yapmayan İç Astar
                        </li>
						<li class="text-muted">
                           Topuk Boyu: 6 cm
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="99" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>153TL</del></span></small></h2>
