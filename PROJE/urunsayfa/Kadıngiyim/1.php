        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty124/product/media/images/20210604/14/95922805/183030197/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty123/product/media/images/20210604/14/95922805/183030197/4/4_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty125/product/media/images/20210604/14/95922805/183030197/3/3_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Aerobin Kumaş Elbise" readonly></h1>
                    
                    <hr>

                    <h6>JANES Kruvaze Yaka Aerobin Kumaş Kuşaklı Elbise90cm </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                          Kruvaze Yaka Janes Aerobin Kumaş Kuşaklı Elbise90cm Bu İlan TİCİMAX Sistemleri ile Listelenmiştir
                        </li>
                        
						 <li class="text-muted">
                        Elbise Rengi :Kırmızı
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="123" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>246TL</del></span></small></h2>
