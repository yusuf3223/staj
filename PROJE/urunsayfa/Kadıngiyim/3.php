        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty154/product/media/images/20210806/19/116371039/223198594/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty153/product/media/images/20210806/19/116371039/223198594/5/5_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty154/product/media/images/20210806/19/116371039/223198594/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Düğmeli Keten Elbise" readonly></h1>
                    
                    <hr>

                    <h6>Bianco Lucci Kadın Askılı Gipeli Önden Düğmeli Keten Elbise </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                         Modelin ölçüleri: Boy:175, göğüs:88, bel:62, kalça: 90. Mankenin üzerindeki beden s/36/1. Ürün kumaşı %100 Cotton. Stüdyo çekimlerinde renkler ışık farklılığından dolayı değişiklik gösterebilir.
                        </li>
                        <li class="text-muted">
                          Elbise Rengi : Beyaz.
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="104" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>200TL</del></span></small></h2>
