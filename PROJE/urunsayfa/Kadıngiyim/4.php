        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty144/product/media/images/20210714/12/110303923/203333122/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty144/product/media/images/20210714/12/110303923/203333122/3/3_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty145/product/media/images/20210714/12/110303923/203333122/4/4_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Kisa Kollu Elbise" readonly></h1>
                    
                    <hr>

                    <h6>Modagusto Kadın Siyah Midi Boy Kısa Kollu Elbise </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                          Modelin Ölçüleri: Boy: 1.75, Göğüs: 89, Bel: 64, Kalça: 92, Beden: S/36/1
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="149" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>219TL</del></span></small></h2>
