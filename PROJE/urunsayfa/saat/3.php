        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty142/product/media/images/20210708/23/108461930/132384009/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty143/product/media/images/20210708/23/108461930/132384009/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty141/product/media/images/20210708/23/108461930/132384009/3/3_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Dokunmatik Kol Saati" readonly></h1>
                    
                    <hr>

                    <h6>istliv Kadın Erkek Su Geçirmez Dokunmatik Kol Saati </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                          * istliv Kol Saati * Günlük kullanım için şık tasarım * Saatler Şık Hediyelik Kutu ile birlikte gönderilmektedir. * Paket içeriği: 1 ADET UNİSEX KOL SAATİ NOT: BİLEKLİK FİYATA DAHİL DEĞİLDİR.... Not: Günlük kullanım için suya dayanıklı 3. ATM Ancak, diğer durumlarda (Deniz ve Havuz) Su geçirir. Çamaşır suyu ve Parfüm gibi kimyasallar metalin rengine zarar verir.
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="65" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>130TL</del></span></small></h2>
