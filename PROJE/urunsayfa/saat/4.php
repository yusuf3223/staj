        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    ...
                    <h6>Casio Kadın Standart Kol Saati LTP-V002D-7BUDF </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                          CAS-LTPV002D7BUDF Casio Standart Kol Saati Türkiye Distribütörü garantilidir. Adınıza düzenlenmiş fatura ve garanti belgesi ile gönderilmektedir.
                        </li>
