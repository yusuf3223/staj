        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty84/product/media/images/20210402/17/f832c2dc/16228321/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty84/product/media/images/20210402/17/f832c2dc/16228321/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty84/product/media/images/20210402/17/f832c2dc/16228321/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Kadın Kol Saati" readonly></h1>
                    
                    <hr>

                    <h6>Aqua Di Polo Kadın Kol Saati APL13C450D02 </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                          Kasa Çapı :38 mm
                        </li>
                        <li class="text-muted">
                          Kasa Materyali : Metal.
                        </li>
						 <li class="text-muted">
                         Cam :Mineral
                        </li>
						 <li class="text-muted">
                          Kordon Materyali : Deri
                        </li>
						 <li class="text-muted">
                         Kordon Rengi :Siyah
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="49" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>100TL</del></span></small></h2>
