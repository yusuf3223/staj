        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty63/product/media/images/20210128/20/58099823/135399586/5/5_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty63/product/media/images/20210128/20/58099823/135399586/4/4_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty62/product/media/images/20210128/20/58099823/135399586/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Bisiklet Yaka T-Shirt" readonly></h1>
                    
                    <hr>

                    <h6>Taş Basic Erkek Oversize Bisiklet Yaka Kısa Kollu T-Shirt </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            Mankenin üzerindeki ürün M bedendir.
                        </li>
                        <li class="text-muted">
                            Modelin Ölçüleri: Boy: 1,88 m, Göğüs: 99, Bel: 84, Kalça: 94
                        </li>
                        <li class="text-muted">
                            %60 Pamuk %40 Polyester
                        </li>
						<li class="text-muted">
                           1 Beden küçük alınabilir.
                        </li>
						<li class="text-muted">
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="30" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>39TL</del></span></small></h2>
