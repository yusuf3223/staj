        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty108/product/media/images/20210429/1/83559571/168265273/0/0_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty108/product/media/images/20210429/1/83559571/168265273/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty109/product/media/images/20210429/1/83559571/168265273/4/4_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Beyaz Keten Gömlek" readonly></h1>
                    
                    <hr>

                    <h6>oshebu Kadın Salaş Kesim Crop Keten Gömlek</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            %100 Pamuk Ürün Boyu 50 cm Manken Ölçüleri
                        </li>
                        <li class="text-muted">
                            Boy
                        </li>
						...
						<li class="text-muted">
                            88 Manken üzerindeki beden S/36 Konsept çekimlerinde ışık farklılığından dolayı renkler farklılık gösterebilir
                        </li>
						<li class="text-muted">
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="70" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>79TL</del></span></small></h2>
