        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty152/product/media/images/20210728/19/113494797/161710978/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty150/product/media/images/20210728/19/113494797/161710978/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty152/product/media/images/20210728/19/113494797/161710978/5/5_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Sarı Yesil Gömlek" readonly></h1>
                    
                    <hr>

                    <h6>Etikmen Panolu Sarı Yeşil Slimfit Keten Gömlek</h6>
                    <ul class="unstyled">
                        
                        <li class="text-muted">
                            Oversize, Uzun, Kenarları Oval Kesim, Rahat Kalıp Gömlek. Stüdyo Çekimlerinde Renkler Işık Farklılığından Dolayı Değişiklik Gösterebilir.
                        </li>
                        <li class="text-muted">
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="124" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>179TL</del></span></small></h2>
