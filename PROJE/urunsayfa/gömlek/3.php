        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty121/product/media/images/20210601/10/94421028/181181938/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty120/product/media/images/20210601/10/94421028/181181938/4/4_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty122/product/media/images/20210601/10/94421028/181181938/3/3_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Uzun Basic Gömlek" readonly></h1>
                    
                    <hr>

                    <h6>Cosmen Erkek Lacivert Slim Fit Hakim Yaka Flam Gömlek</h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                            %100 pamuk keten kumaş kol katlamalı resimdeki ürün m bedendir manken ölçüleri:Boy:185 kilo:75 göğüs:98 bel:81 basen:93 omuz:123 stüdyo çekimlerinde renkler ışık farklılığından dolayı değişiklik gösterebilir. Giysilerin daha uzun süre yeniliğini koruyabilmesi için bakım etiketindeki öneriler dikkate alınmalıdır. Öncelikle yıkanacak olan giysilerin doğru ayrılmış olması önemlidir. Renklerine, ürün özelliklerine ve kullanım alanlarına göre giysiler gruplandırılmalı, doğru programda uygun deterjan ve sıcaklıkta yıkanmalı
                        </li>
                        
                        <li class="text-muted">
                            Boy: 1.76 cm, Göğüs: 86 cm Bel: 60 cm Kalça: 90 cm
                        </li>
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="84" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>189TL</del></span></small></h2>
