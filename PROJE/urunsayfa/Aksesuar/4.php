        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty128/product/media/images/20210608/14/97349660/184689856/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty128/product/media/images/20210608/14/97349660/184689856/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty128/product/media/images/20210608/14/97349660/184689856/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="3 lü Bileklik Seti" readonly></h1>
                    
                    <hr>

                    <h6>DGN Shoping Kadın 3 lü Çoklu Istiridye Zincir Bileklik Seti </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                          Su, parfüm, krem gibi kimyasal maddelerden uzak tutulduğu sürece kararma olmaz
                        </li>
                        <li class="text-muted">
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="12" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>49TL</del></span></small></h2>
