        ...
        <div class="row">
                        ...
                        <div id="carousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty154/product/media/images/20210804/23/115750270/176492519/1/1_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty155/product/media/images/20210804/23/115750270/176492519/2/2_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-1">
                                </div>
                                <div class="carousel-item">
                                    <img src="https://cdn.dsmcdn.com/mnresize/1200/1800/ty155/product/media/images/20210804/23/115750270/176492519/4/4_org_zoom.jpg" class="d-block w-100" height="600" alt="cimbizaracgerec16-2">
                                </div>
                                </div>
            ...
            <div class="col-12 col-md-6">
                <form method="POST" action="../../php/sepetekle.php">
                    <h1><input type="text" style="border:none transparent;outline:none;text-align:left;font-weight:500;" id="urunAdi" name="urunAdi" value="Deri Kemer" readonly></h1>
                    
                    <hr>

                    <h6>derimond Erkek Deri Kemer Kot Ve Kanvasa Uygun </h6>
                    <ul class="unstyled">
                        <li class="text-muted">
                          deribond Erkek Deri Kemer Kot Ve Kanvasa Uygun
                        </li>
                        <li class="text-muted">
					...
					<h2 class="float-right text-danger"><input type="text" class="text-danger mb-5" style="border:none transparent;outline:none;text-align:right;font-weight:500;" id="urunFiyat" name="urunFiyati" value="14" readonly>TL  <small><span class="text-secondary" style="text-align:right"><del>49TL</del></span></small></h2>
